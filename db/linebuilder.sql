...
(PG1.CriteriaRanking + PG2.CriteriaRanking + SG1.CriteriaRanking + SG2.CriteriaRanking + SF1.CriteriaRanking + SF2.CriteriaRanking + PF1.CriteriaRanking + PF2.CriteriaRanking + C.CriteriaRanking) as 'CriteriaRanking',
(PG1.ProjScore + PG2.ProjScore + SG1.ProjScore + SG2.ProjScore + SF1.ProjScore + SF2.ProjScore + PF1.ProjScore + PF2.ProjScore + C.ProjScore)/9 as 'TotalProjScore',
(PG1.PTsVPos + PG2.PTsVPos + SG1.PTsVPos + SG2.PTsVPos + SF1.PTsVPos + SF2.PTsVPos + PF1.PTsVPos + PF2.PTsVPos + C.PTsVPos)/9 as 'PPP',
